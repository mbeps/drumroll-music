...
const itemVariants = cva(
  "group/item flex flex-wrap items-center rounded-md text-sm outline-none transition-colors duration-100 focus-visible:ring-[3px] focus-visible:ring-ring/50 [a]:transition-colors [a]:hover:bg-accent/50",
  {
    variants: {
      variant: {
